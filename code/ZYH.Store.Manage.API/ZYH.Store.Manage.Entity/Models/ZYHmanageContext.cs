...
namespace ZYH.Store.Manage.Entity.Models
{
    public partial class ZYHmanageContext : DbContext
    {
        ...
        static ZYHmanageContext()
        {
            IConfigurationBuilder config = new ConfigurationBuilder();
            config.AddJsonFile("appsettings.json", optional: true);
            var build = config.Build();
            connStr = build.GetSection("DB:SqlServer").Value ?? "";
        }

        public ZYHmanageContext()
        {
        }
        public ZYHmanageContext(string conn)
        {
        ...
        public virtual DbSet<InOrOutMoneyStatisticsRealTime> InOrOutMoneyStatisticsRealTime { get; set; }
            ...
            modelBuilder.Entity<DepartmentEmployee>(entity =>
        {
            ...
            {
                entity.ToTable("InOrOutMoneyStatistics");
            });
            modelBuilder.Entity<InOrOutMoneyStatisticsRealTime>(entity =>
            {
                entity.ToTable("InOrOutMoneyStatisticsRealTime");
                entity.Property(m => m.LastTime).HasColumnType("datetime");
            });
